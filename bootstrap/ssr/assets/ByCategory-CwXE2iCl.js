...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="bg-white rounded-md shadow overflow-x-auto"><table class="w-full whitespace-nowrap"><tbody><tr class="text-left font-bold"><th class="px-6 pt-6 pb-4">${ssrInterpolate(_ctx.$t("Title"))}</th><th class="px-6 pt-6 pb-4">${ssrInterpolate(_ctx.$t("Type"))}</th><th class="px-6 pt-6 pb-4">${ssrInterpolate(_ctx.$t("Is Active"))}</th><th class="px-6 pt-6 pb-4">Created At</th></tr><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Blogs/ByCategory.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ByCategory = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
