      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-6">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-2xl font-bold text-slate-900 dark:text-white">{{ $t('Blog Posts Management') }}</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <td class="px-6 py-4">
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <p v-if="post.excerpt" class="text-sm text-slate-500 dark:text-slate-400 truncate">
                        {{ post.excerpt }}
                      </p>
                    </div>
                  </Link>
        ...
        <div v-if="posts.data.length === 0" class="text-center py-12">
          ...
          <h3 class="text-lg font-medium text-slate-900 dark:text-white mb-2">{{ $t('No posts found') }}</h3>
          <p class="text-slate-500 dark:text-slate-400 mb-6">{{ $t('Get started by creating your first blog post.') }}</p>
          <Link
            :href="route('posts.create')"
...
export default {
  ...
  methods: {
    ...
    reset() {
      ...
      this.$inertia.get(route('posts'))
    },
    deletePost(post) {
      this.showDeleteConfirmation({
        title: this.$t('Delete Post'),
    ...
    getTypeColor(type) {
      const colors = {
        ...
        announcement: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400'
      }
