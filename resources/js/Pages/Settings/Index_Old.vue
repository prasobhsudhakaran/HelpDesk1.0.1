        ...
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
            ...
            <div class="pb-8 pr-6 w-full flex lg:w-1/3">
                <div class="w-full lg:w-4/5">
                    <file-input v-model="form.logo" :error="form.errors.logo" class="pr-2 w-full" type="file" accept="image/png" label="Logo" />
            ...
            <div class="pb-8 pr-6 w-full flex lg:w-1/3">
                <div class="w-full lg:w-4/5">
                    <file-input v-model="form.logo_white" :error="form.errors.logo_white" class="pr-2 w-full" type="file" accept="image/png" label="Logo White" />
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                        {{ $t('Recommended: 200-300px width, 60-100px height (2:1 to 3:1 ratio)') }}
                    </p>
                </div>
            ...
            <div class="pb-8 pr-6 w-full flex lg:w-1/3">
                <div class="w-full lg:w-4/5">
                    <file-input v-model="form.favicon" :error="form.errors.favicon" class="pr-2 w-full" type="file" accept="image/png" label="Favicon" />
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
