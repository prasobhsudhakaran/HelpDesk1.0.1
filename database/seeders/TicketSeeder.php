...
class TicketSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Ticket::factory(20)->create()->each(function ($ticket) use($users, $departments, $categories, $statuses, $priorities, $allowedAgents){
            $assignedTo = $allowedAgents->isNotEmpty() ? $allowedAgents->random()->id : null;
            ...
            $ticket->update(['status_id' => $statuses->random()->id,
                ...
                'category_id' => $categories->random()->id, 'assigned_to' => $assignedTo
            ]);
        });
    }
}
