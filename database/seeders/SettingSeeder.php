...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert(['name' => 'Main Logo', 'slug' => 'main_logo', 'type' => 'text', 'value' => '/images/logo.png']);
        DB::table('settings')->insert(['name' => 'Main Logo White', 'slug' => 'main_logo_white', 'type' => 'text', 'value' => '/images/logo_white.png']);
        DB::table('settings')->insert(['name' => 'Main Favicon', 'slug' => 'main_favicon', 'type' => 'text', 'value' => '/favicon.png']);
